        ...
        <div className="flex flex-col items-center justify-center min-h-screen w-full text-white">
            ...
            >
                ...
                <TabsContent value="step3">
                    <div className="text-center bg-white/10 p-6 rounded-lg border border-white/20 shadow-lg">
                        ...
                        <Link href="/dashboard">
                            <Button className="mt-4 bg-blue-500 hover:bg-blue-600 text-gray-900">
                                Go to Dashboard
                            </Button>
                        </Link>
                    </div>
            ...
            {activeTab !== "step3" && (
                <div className="mt-4 flex gap-4">
                    <button
                        onClick={prevStep}
                        className={`px-4 py-2 rounded-lg text-white bg-gray-500 hover:bg-gray-600 ${activeTab === "step1" ? "cursor-not-allowed opacity-50" : ""
                            }`}
                    ...
                    <button
                        onClick={nextStep}
                        className={`px-4 py-2 rounded-lg text-white ${activeTab === "step1" && !selectedBlockchain
